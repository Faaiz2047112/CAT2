...
var xmlString = "<?xml version = '1.0'?>" +
    "<CHRIST> " +
    "   <student rollNo = '393'> " +
    "      <STU_NAME>Faaiz Ali</STU_NAME> " +
    "      <STU_BRANCH>Computer Science</STU_BRANCH> " +
    "      <EMAIL>faaiz.ali@cs.christuniversity.in</EMAIL> " +
    "      <STU_COLLEGE>CHRIST COLLEGE</STU_COLLEGE> " +
    "   </student> "

    +
    "   <student rollNo = '493'> " +
    "      <STU_NAME>Mansoor</STU_NAME> " +
    "      <STU_BRANCH>Business analytic</STU_BRANCH> " +
    "      <EMAIL>mansoor@ds.christuniversity.in</EMAIL> " +
    "      <STU_COLLEGE>CHRIST COLLEGE</STU_COLLEGE> " +
    "   </student> "

    +
    "   <student rollNo = '593'> " +
    "      <STU_NAME>Gaurav sharma</STU_NAME> " +
    "      <STU_BRANCH>Computer Science</STU_BRANCH> " +
    "      <EMAIL>gauravs.christuniversity.in</EMAIL> " +
    "      <STU_COLLEGE>CHRIST COLLEGE</STU_COLLEGE> " +
    "   </student> " +
    "</CHRIST> ";
